...
- [ ] Close semantic fail-open gaps: nested struct/array member validation and
...
- Framework adapters, MCP server, FastAPI service, batch API, intent/SQL
  consistency models, and automatic LLM repair convenience APIs.
